...
export class Dbox {
  constructor(ele, config) {
    ...
    this.MODEL_STATIC_BASE_PATH =
      process.env.NODE_ENV === 'production' ? 'https://image.zhushuhebao.com/model/' : 'http://192.168.31.97/model/'
    this.sence_data = getSence(config.sence)
    this.cameraObj = {}
    this.eventObj = {}
  }
}
